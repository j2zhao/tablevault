Currently, users can store the various data types in TableVault: **file list**, **document list**, **embedding list**, and **record list**. TableVault also generates a new **process list** for each individual Python process.
