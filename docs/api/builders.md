...
**Why this custom code pattern matters:** each yielded row is immediately committed. If your job dies, rerunning the builder simply skips what’s already in `self_df`.
