...
def basic_function_cli(db_dir: str, author: str) -> None:
    ...
    run_cli("create-instance", "llm_storage",
            "--builder", "upload_openai")
    run_cli("create-instance", "llm_questions",
            "--builder", "question_1", "--builder", "question_2", "--builder", "question_3")

    # ---------- 3. builder files ---------------------------------------------
    tests_dir = Path("tests/test_data")
    run_cli("create-builder-file", "stories",
            "--copy-dir", tests_dir / "test_data_db/stories/stories_index.yaml")
    run_cli("create-builder-file", "llm_storage",
            "--copy-dir", tests_dir / "test_data_db_selected/llm_storage")
    run_cli("create-builder-file", "llm_questions",
            "--copy-dir", tests_dir / "test_data_db_selected/llm_questions")
