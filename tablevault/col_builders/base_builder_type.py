...
from tablevault.col_builders.utils.table_string import TableValue, TableReference, parse_table_string, apply_table_string
...
class TVBuilder(BaseModel):
    name: Union[str, TableReference] = Field(description="Name of builder (autogenerated). Do not have to file.")
    ...
    dependencies: list[TableValue] = Field(description="Specifies table dependecies of this builder (autogenerated).")
    changed_columns: list[Union[str, TableReference]] = Field(description="Specifies the output column names that are generated.")
    builder_type: Union[str, TableReference] = Field(description="Type of builder. See tablevault.col_builders.builder_type_mapping for currently supported Builders.")
...
def _get_table_dependencies(table_name: str, builders: dict[str, TVBuilder]) -> list[str]:
    dependencies = set()
