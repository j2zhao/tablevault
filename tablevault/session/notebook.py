...
class SessionNotebook:
    def __init__(self, db: StandardDatabase, name: str, user_id: str, parent_session_name: str, parent_session_index: int) -> None:
        ...
        session_collection.create_session(db, name, user_id, "notebook", parent_session_name, parent_session_index)
