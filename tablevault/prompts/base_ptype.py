...
from tablevault.prompts.table_string import DataTable, TableReference
...
class TVPrompt(BaseModel):
    ...
    dependencies: list[DataTable] = Field(description="Specifies table dependecies of this prompt (autogenerated).")
...
def _get_prompt_dependencies(values):
    if isinstance(values, DataTable):
        return [DataTable]
